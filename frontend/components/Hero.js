...
import { Box, Heading, Container, Text, Button, Stack, Icon, useColorModeValue, createIcon, Link as ChakraLink } from '@chakra-ui/react';
          ...
          <Stack direction={'column'} spacing={3} align={'center'} alignSelf={'center'} position={'relative'}>
            ...
            <Stack direction={'row'}>
              ...
              <NextLink href="/signin" passHref>
                <Button as={ChakraLink} variant={'link'} colorScheme={'blue'} size={'sm'}>
                  Sign In
                </Button>
              </NextLink>
            </Stack>
            ...
            <Box>
              <Icon as={Arrow} color={useColorModeValue('gray.800', 'gray.300')} w={6} h={6} position={'absolute'} right={-6} top={'10px'} />
